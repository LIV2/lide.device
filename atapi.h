...
#define ATAPI_DRQ_WAIT_LOOP_US 1.4
#define ATAPI_DRQ_WAIT_MS 500
#define ATAPI_DRQ_WAIT_COUNT (ATAPI_DRQ_WAIT_MS * (1000 / ATAPI_DRQ_WAIT_LOOP_US))

#define ATAPI_BSY_WAIT_LOOP_SHORT_US 1.4
#define ATAPI_BSY_WAIT_SHORT_S       40

#define ATAPI_BSY_WAIT_LOOP_LONG_US 1000
#define ATAPI_BSY_WAIT_MEDIUM_S     120 // 2 Minutes
#define ATAPI_BSY_WAIT_LONG_S       1800 // 30 Minutes

#define ATAPI_BSY_WAIT_COUNT_SHORT (ATAPI_BSY_WAIT_SHORT_S * 1000 * (1000 / ATAPI_BSY_WAIT_LOOP_SHORT_US))
#define ATAPI_BSY_WAIT_COUNT_MEDIUM (ATAPI_BSY_WAIT_MEDIUM_S * 1000 * (1000 / ATAPI_BSY_WAIT_LOOP_LONG_US))
#define ATAPI_BSY_WAIT_COUNT_LONG (ATAPI_BSY_WAIT_LONG_S * 1000 * (1000 / ATAPI_BSY_WAIT_LOOP_LONG_US))
